...
26-02-19　Ver3.3.1-FIX【1.15.0.2】
							・【公開機能を使用可能にする】
									名称変更。
　　　　　　　　　			・【公開系機能全般】
...
26-09-08　Ver3.4.0.2【Web1.15.0.4 / API1.15.0.4 / DB1.15.0.2】
				【修正】	・【操作】-【印刷モード】
				...
				【BugFixes】・ゼロ長コメントのPDFで押印位置指定を用いた印刷を行うと、TeCAが強制ログオフの件を修正（ZUNO_TECA-372)
				              PDF編集でゼロ長コメントのPDFを開き、押印位置指定を用いた印刷を行うと、TeCAが強制ログオフする不具合も修正。（ZUNO_TECA-372)
